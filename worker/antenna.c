    ...
    for (r = 0; r < nrows; r++) 
    {
        ...
        { 
            ...
            else 
            {
                ...
                loss_out = antenna_influence_on_point (d_east,
                                                       d_north,
                                                       total_tx_height,
                                                       beam_direction,
                                                       mechanical_tilt,
 ...
 *                      radio zone to which each point belongs (output
 *                      parameter);
 *
 * WARNING: the output of this function overwrites `m_loss` and `m_radio_zone`!
 *
 */
void
